...
import static com.weixin.pay.sdk.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
     ...
     * @param uuid             UUID
     * @param data             数据
     * @param connectTimeoutMs 连接超时毫秒值
     * @param readTimeoutMs    读取超时毫秒值
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs,
        ...
        try {
            String result = requestOnce(domainInfo.getDomain(), urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, useCert);
     ...
     * @return
     */
    public String requestWithoutCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs,
