...
public class WXPay {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        WXPayConstants.SignType signType2;
        if (signTypeInData == null) {
            signType2 = WXPayConstants.SignType.MD5;
        } else {
            ...
            if (signTypeInData.length() == 0) {
                ...
                signType2 = WXPayConstants.SignType.HMACSHA256;
            } else {
                throw new Exception(String.format("Unsupported sign_type: %s", signTypeInData));
            }
        }
        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), signType2);
    }
    ...
    public Map<String, String> processResponseXml(String xmlStr) throws Exception {
        String defaultReturnCode = "return_code";
        String returnCode;
        Map<String, String> respData = WXPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(defaultReturnCode)) {
            returnCode = respData.get(defaultReturnCode);
        } else {
